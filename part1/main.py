...
sys.path.append('/Users/yuxuanhu/Desktop/mnist')
from utils import *
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    test_error_mod3 = compute_test_error_mod3(test_x, test_y_mode3, theta, temp_parameter)
...
def run_pca_on_MNIST(temp_parameter=1):
...
# print('softmax test_error_pca=', run_pca_on_MNIST(temp_parameter=1))
...
def run_cubic_on_MNIST(temp_parameter=1):
    ...
    return test_error_cube

print('softmax test_error_pca=', run_cubic_on_MNIST(temp_parameter=1))

def polys_svm(train_pca10, train_y, test_pca10):
    lin_clf = svm.SVC(random_state=0, kernel='rbf')
    lin_clf.fit(train_pca10, train_y)
    test_y = lin_clf.predict(test_pca10)
    return test_y

predictions = polys_svm(train_pca10, train_y, test_pca10)
error_rate = np.mean(predictions != test_y)
print(f"Error rate using cubic polynomial SVM: {error_rate:.4f}")
